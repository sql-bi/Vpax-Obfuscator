namespace Dax.Tokenizer
{
    public sealed partial class DaxToken
    {
	    ...
	    public const int FALSE=57;
	    /// <summary>https://dax.guide/ABS</summary>
	    public const int ABS=58;
	    /// <summary>https://dax.guide/REL</summary>
	    public const int REL=59;
	    /// <summary>https://dax.guide/WITH</summary>
	    public const int WITH=60;
	    /// <summary>https://dax.guide/VISUAL</summary>
	    public const int VISUAL=61;
	    /// <summary>https://dax.guide/SHAPE</summary>
	    public const int SHAPE=62;
	    /// <summary>https://dax.guide/AXIS</summary>
	    public const int AXIS=63;
	    /// <summary>https://dax.guide/ROWS</summary>
	    public const int ROWS=64;
	    /// <summary>https://dax.guide/COLUMNS</summary>
	    public const int COLUMNS=65;
	    /// <summary>https://dax.guide/GROUP</summary>
	    public const int GROUP=66;
	    /// <summary>https://dax.guide/TOTAL</summary>
	    public const int TOTAL=67;
	    /// <summary>https://dax.guide/DENSIFY</summary>
	    public const int DENSIFY=68;
	    /// <summary>https://dax.guide/ANYVAL</summary>
	    public const int ANYVAL=69;
	    /// <summary>https://dax.guide/SCALAR</summary>
	    public const int SCALAR=70;
	    /// <summary>https://dax.guide/ANYREF</summary>
	    public const int ANYREF=71;
	    /// <summary>https://dax.guide/COLUMNREF</summary>
	    public const int COLUMNREF=72;
	    /// <summary>https://dax.guide/TABLEREF</summary>
	    public const int TABLEREF=73;
	    /// <summary>https://dax.guide/MEASUREREF</summary>
	    public const int MEASUREREF=74;
	    /// <summary>https://dax.guide/CALENDARREF</summary>
	    public const int CALENDARREF=75;
	    /// <summary>https://dax.guide/INT64</summary>
	    public const int INT64=76;
	    /// <summary>https://dax.guide/DECIMAL</summary>
	    public const int DECIMAL=77;
	    /// <summary>https://dax.guide/NUMERIC</summary>
	    public const int NUMERIC=78;
	    /// <summary>https://dax.guide/EXPR</summary>
	    public const int EXPR=79;
	    /// <summary>https://dax.guide/VAL</summary>
	    public const int VAL=80;
	    /// <summary>https://dax.guide/EXTENDING</summary>
	    public const int EXTENDING=81;
	    /// <summary>https://dax.guide/PRECISE</summary>
	    public const int PRECISE=82;
	    /// <summary>https://dax.guide/ANCHORED</summary>
	    public const int ANCHORED=83;
	    /// <summary>https://dax.guide/Z__LASTKEYWORD__</summary>
	    public const int Z__LASTKEYWORD__=84;
	    /// <summary>https://dax.guide/Z__FIRSTPROPERTY__</summary>
	    public const int Z__FIRSTPROPERTY__=85;
	    /// <summary>https://dax.guide/DISPLAYFOLDER</summary>
	    public const int DISPLAYFOLDER=86;
	    /// <summary>https://dax.guide/FORMATSTRING</summary>
	    public const int FORMATSTRING=87;
	    /// <summary>https://dax.guide/DESCRIPTION</summary>
	    public const int DESCRIPTION=88;
	    /// <summary>https://dax.guide/VISIBLE</summary>
	    public const int VISIBLE=89;
	    /// <summary>https://dax.guide/DATATYPE</summary>
	    public const int DATATYPE=90;
	    /// <summary>https://dax.guide/KPISTATUSEXPRESSION</summary>
	    public const int KPISTATUSEXPRESSION=91;
	    /// <summary>https://dax.guide/KPISTATUSDESCRIPTION</summary>
	    public const int KPISTATUSDESCRIPTION=92;
	    /// <summary>https://dax.guide/KPISTATUSGRAPHIC</summary>
	    public const int KPISTATUSGRAPHIC=93;
	    /// <summary>https://dax.guide/KPITRENDEXPRESSION</summary>
	    public const int KPITRENDEXPRESSION=94;
	    /// <summary>https://dax.guide/KPITRENDDESCRIPTION</summary>
	    public const int KPITRENDDESCRIPTION=95;
	    /// <summary>https://dax.guide/KPITRENDGRAPHIC</summary>
	    public const int KPITRENDGRAPHIC=96;
	    /// <summary>https://dax.guide/KPITARGETEXPRESSION</summary>
	    public const int KPITARGETEXPRESSION=97;
	    /// <summary>https://dax.guide/KPITARGETDESCRIPTION</summary>
	    public const int KPITARGETDESCRIPTION=98;
	    /// <summary>https://dax.guide/KPITARGETFORMATSTRING</summary>
	    public const int KPITARGETFORMATSTRING=99;
	    /// <summary>https://dax.guide/PRECEDENCE</summary>
	    public const int PRECEDENCE=100;
	    /// <summary>https://dax.guide/ORDINAL</summary>
	    public const int ORDINAL=101;
	    /// <summary>https://dax.guide/Z__LASTPROPERTY__</summary>
	    public const int Z__LASTPROPERTY__=102;
	    /// <summary>https://dax.guide/DATE_LITERAL</summary>
	    public const int DATE_LITERAL=103;
	    /// <summary>https://dax.guide/INTEGER_LITERAL</summary>
	    public const int INTEGER_LITERAL=104;
	    /// <summary>https://dax.guide/REAL_LITERAL</summary>
	    public const int REAL_LITERAL=105;
	    /// <summary>https://dax.guide/STRING_LITERAL</summary>
	    public const int STRING_LITERAL=106;
	    /// <summary>https://dax.guide/TABLE</summary>
	    public const int TABLE=107;
	    /// <summary>https://dax.guide/COLUMN_OR_MEASURE</summary>
	    public const int COLUMN_OR_MEASURE=108;
	    /// <summary>https://dax.guide/TABLE_OR_VARIABLE</summary>
	    public const int TABLE_OR_VARIABLE=109;
	    /// <summary>https://dax.guide/OTHER_IDENTIFIER</summary>
	    public const int OTHER_IDENTIFIER=110;
	    /// <summary>https://dax.guide/OPEN_CURLY</summary>
	    public const int OPEN_CURLY=111;
	    /// <summary>https://dax.guide/CLOSE_CURLY</summary>
	    public const int CLOSE_CURLY=112;
	    /// <summary>https://dax.guide/OPEN_PARENS</summary>
	    public const int OPEN_PARENS=113;
	    /// <summary>https://dax.guide/CLOSE_PARENS</summary>
	    public const int CLOSE_PARENS=114;
	    /// <summary>https://dax.guide/COMMA</summary>
	    public const int COMMA=115;
	    /// <summary>https://dax.guide/Z__FIRSTOPERATOR__</summary>
	    public const int Z__FIRSTOPERATOR__=116;
	    /// <summary>https://dax.guide/PLUS</summary>
	    public const int PLUS=117;
	    /// <summary>https://dax.guide/MINUS</summary>
	    public const int MINUS=118;
	    /// <summary>https://dax.guide/STAR</summary>
	    public const int STAR=119;
	    /// <summary>https://dax.guide/DIV</summary>
	    public const int DIV=120;
	    /// <summary>https://dax.guide/CARET</summary>
	    public const int CARET=121;
	    /// <summary>https://dax.guide/AMP</summary>
	    public const int AMP=122;
	    /// <summary>https://dax.guide/STRICTEQ</summary>
	    public const int STRICTEQ=123;
	    /// <summary>https://dax.guide/EQ</summary>
	    public const int EQ=124;
